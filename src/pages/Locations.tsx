...
import mapin from '../assets/icons/mappin.png';
  ...
  const Locations = () => {
    ...
    return (
      <div className="">
        ...
        <div className="max-w-full px-3 md:px-10 lg:px-15 xl:px-25 py-12">
          {/* Search Bar */}
          <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredLocations.map((location) => (
              <div
                key={location.id}
                className="bg-white rounded-2xl border border-gray-200 p-9 hover:shadow-lg transition-shadow cursor-pointer"
              >
                ...
                <div className="flex items-start gap-2">
                  ...
                  <img
                    src={mapin}
                    className="w-5 h-5 text-pink-500 flex-shrink-0 mt-2"
                  />
