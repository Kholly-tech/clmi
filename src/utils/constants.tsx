export const constants = {
  navItems: [
    ...
    { label: "Livestreams", link: "/livestreams" },
    { label: "Giving & Support", link: "/giving" },
  ],
  homeTexts: {
    text1:
      "Welcome to Comfort Life Mission International , where destinies are shaped through the undiluted Word of God, prophetic prayer, and vibrant fellowship. Join us and experience a supernatural move of God that transforms lives daily",
    text2:
      "Comfort Life Mission International was born out of a divine burden laid on Pastor Odekunle Ephaphras in 1988. Starting as a youth-focused evening fellowship in a primary school classroom, the ministry has since grown into a vibrant movement touching lives through prayer, the Word, and outreaches.",
  },
  whatWeStandFor: [
    {
      title: "Holiness",
      desc: "We stand for holiness and righteousness. Our core values lies on holiness and purity",
      verse: "Hebrews 12:14",
    },
    {
      title: "Holiness",
