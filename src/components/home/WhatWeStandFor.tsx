...
const WhatWeStandFor = () => {
  return (
    <div className="items-center justify-center my-15">
      <h2 className="text-primary font-bold text-4xl text-center mb-10">What We Stand For</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 px-3 md:px-10 lg:px-15 xl:px-25 gap-6">
        {constants.whatWeStandFor.map((item, i:number) => (
          <div className="border-2 border-black/30 text-black/70 rounded-2xl p-6" key={i}>
